...
function search(){
    ...
    currentNode.neighbours.forEach(neighbour => {
        if(!neighbour.isVisited){
            if(currentNode.cost + currentNode.distanceToEnd + 1 > neighbour.cost + currentNode.distanceToEnd){
...
function sortPriorityQueue(){
    priorityQueue.sort(function (a, b){
        return (a.distanceToEnd+a.cost) - (b.distanceToEnd+b.cost);
    });
}
